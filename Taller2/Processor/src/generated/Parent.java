...
@XmlType(name = "parent", propOrder = { "andOrAltOrOr" })
@XmlSeeAlso({ Alt.class, Or.class, And.class })
public class Parent extends NamedElement {

	@XmlElements({ @XmlElement(name = "and", type = And.class), @XmlElement(name = "alt", type = Alt.class),
			@XmlElement(name = "or", type = Or.class), @XmlElement(name = "feature", type = Feature.class),
	 ...
	 * <CODE>set</CODE> method for the andOrAltOrOr property.
	 * 
	 * <p>
	 ...
	 * {@link Alt } {@link Or } {@link Feature } {@link String }
	 * 
	 * 
	 */
