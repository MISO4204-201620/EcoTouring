...
@XmlType(name = "", propOrder = { "varOrNot" })
@XmlRootElement(name = "imp")
public class Imp {

	@XmlElements({ @XmlElement(name = "var", type = String.class), @XmlElement(name = "not", type = Not.class) })
	 ...
	 * <CODE>set</CODE> method for the varOrNot property.
	 * 
	 * <p>
