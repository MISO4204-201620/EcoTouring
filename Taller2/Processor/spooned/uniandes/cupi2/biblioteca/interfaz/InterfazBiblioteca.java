 ...
 */
@annotation.andFT(mandatory = "true", parent = "Biblioteca")
public class InterfazBiblioteca extends javax.swing.JFrame {
     ...
     */
    @annotation.featureFT(mandatory = "true", name = "registrarUsuario")
     ...
     */
    @annotation.featureFT(mandatory = "true")
     ...
     */
    @annotation.featureFT(parent = "InterfazBiblioteca")
     ...
     */
    @annotation.featureFT(mandatory = "true", parent = "InterfazBiblioteca")
