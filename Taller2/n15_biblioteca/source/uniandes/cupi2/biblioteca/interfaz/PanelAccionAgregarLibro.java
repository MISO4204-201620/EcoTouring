 ...
 */
@altFT(mandatory="true", parent="Biblioteca")
public class PanelAccionAgregarLibro extends JPanel implements ActionListener
{
    ...
    public PanelAccionAgregarLibro( InterfazBiblioteca nPrincipal )
    {
        ...
        setOpaque( false );
        // Inserción en el panel de los elementos.
     ...
     */
    @featureFT(parent="PanelAccionAgregarLibro")
    ...
    private void accionBotonInsertarNuevoLibro( )
    {
        ...
        {
            JOptionPane.showMessageDialog( principal, "Ingrese el título", "Error", JOptionPane.ERROR_MESSAGE );
            return;
        }
